...
setcolor(MAGENTA);
settextstyle(0,0,5);
outtextxy(70,2," SNAKE GAME ");
settextstyle(6,0,2);
outtextxy(50,80," Use Arrow Keys To Direct The Snake ");
outtextxy(50,140," Avoid touching the head of the snake to it's body");
outtextxy(50,160," Pick The Beads Until You Win The Game ");
outtextxy(50,200," Press 'Esc' Anytime To Exit ");
outtextxy(50,220," Press Any Key To Continue ");
ch=getch();
if(ch==27) exit(0);
cleardevice();
maxx=getmaxx();
